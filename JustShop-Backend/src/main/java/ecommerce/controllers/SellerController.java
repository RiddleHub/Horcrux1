...
public class SellerController {
	...
	@PostMapping
	@ApiOperation(value="Save a seller details",response = Seller.class)
	...
	@GetMapping
	@ApiOperation(value="List all seller",response=Iterable.class)
	...
	@GetMapping("{id}")
	@ApiOperation(value="Display the details of a seller")
	...
	@DeleteMapping("{id}")
	@ApiOperation(value="Delete the details of a seller")
	...
	@ApiOperation(value="Validate the details of a seller")
